...
#ifdef QTI_BSP
    HWC_DISPLAY_TERTIARY    = 8,
    HWC_DISPLAY_VIRTUAL     = 9,

    HWC_NUM_PHYSICAL_DISPLAY_TYPES = 10,
    HWC_NUM_DISPLAY_TYPES          = 11,
#else
    HWC_DISPLAY_VIRTUAL     = 11,

    HWC_NUM_PHYSICAL_DISPLAY_TYPES = 12,
    HWC_NUM_DISPLAY_TYPES          = 13,
#endif
};
